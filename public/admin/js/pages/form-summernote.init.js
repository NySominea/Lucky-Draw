!(function(n) {
    ...
    (e.prototype.init = function() {
        ...
        n("#summernote-edit").on("click", function() {
            ...
            n
                .ajax({ url: "https://api.github.com/emojis", async: !1 })
                .then(function(e) {
            ...
            n("#summernote-hint-mentions").summernote({
                ...
                hint: {
                    ...
                    search: function(t, e) {
                        e(
                            n.grep(this.mentions, function(e) {
                                return 0 == e.indexOf(t);
                            })
                        );
                    },
